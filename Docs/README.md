...
$$\forall \text{hist}, n, h. \text{K\textunderscore LZ}(\text{join}(\text{R\textunderscore G1}(n, h)::\text{hist})) \leq \text{K\textunderscore LZ}(\text{join}(\text{hist})) + \text{c\textunderscore time}$$
