...
// Module: SubstrateTheory.Bridge.Convergence
// Imports: public import Init public import SubstrateTheory.Ideal.Complexity public import SubstrateTheory.Operational.Complexity public import SubstrateTheory.Core.Grounding public import Mathlib.Data.Finset.Basic public import Mathlib.Analysis.SpecialFunctions.Exp public import Mathlib.Analysis.SpecialFunctions.Log.Basic
#include <lean/lean.h>
...
lean_object* initialize_SubstrateTheory_Core_Grounding(uint8_t builtin, lean_object*);
...
LEAN_EXPORT lean_object* initialize_SubstrateTheory_Bridge_Convergence(uint8_t builtin, lean_object* w) {
lean_object * res;
...
if (lean_io_result_is_error(res)) return res;
lean_dec_ref(res);
res = initialize_SubstrateTheory_Core_Grounding(builtin, lean_io_mk_world());
if (lean_io_result_is_error(res)) return res;
lean_dec_ref(res);
