...
// Module: SubstrateTheory.Physics.Cosmology
// Imports: public import Init public import SubstrateTheory.Core.Types public import SubstrateTheory.Core.Parameters public import SubstrateTheory.Core.MasterTheorem public import SubstrateTheory.Ideal.Complexity public import SubstrateTheory.Operational.Complexity public import Mathlib.Data.Real.Basic
#include <lean/lean.h>
...
lean_object* initialize_SubstrateTheory_Core_MasterTheorem(uint8_t builtin, lean_object*);
...
LEAN_EXPORT lean_object* initialize_SubstrateTheory_Physics_Cosmology(uint8_t builtin, lean_object* w) {
lean_object * res;
...
if (lean_io_result_is_error(res)) return res;
lean_dec_ref(res);
res = initialize_SubstrateTheory_Core_MasterTheorem(builtin, lean_io_mk_world());
if (lean_io_result_is_error(res)) return res;
lean_dec_ref(res);
